                    ...
                    <div className="col-12 d-flex align-items-center justify-content-center">
                        <div className="col-md-4 col-10 p-0">
                            ...
                            <div className="card-footer bg-transparent">
                                <div className="row">
                                    <p className="text-muted text-center col-12 py-1">© 2016 <a href="/">Stack </a>Crafted with <i className="ft-heart pink"> </i>  by <a href="http://themeforest.net/user/pixinvent/portfolio" >Nhat Le</a></p>
